...
cat /private/groups/patenlab/mira/centrolign/batch_submissions/centrolign/HPRC_chr12_2_25_25_tree_initial_test_nogaps/chr12/sample_ids.in_nwk.txt | while read line ; do grep $line /private/groups/patenlab/mira/centrolign/giraffe/pairwise_dist_lt0.5.csv ; done | sort | uniq > /private/groups/patenlab/mira/centrolign/giraffe/pairwise_alns_inside_graph.csv
...
grep -v -f /private/groups/patenlab/mira/centrolign/batch_submissions/centrolign/HPRC_chr12_2_25_25_tree_initial_test_nogaps/chr12/sample_ids.in_nwk.txt samps > /private/groups/patenlab/mira/centrolign/giraffe/samples_aligning_well_not_in_graph.txt
...
Sample in Faith's graph: `HG00408.1`
chosen from here:
```
/private/groups/patenlab/mira/centrolign/batch_submissions/centrolign/HPRC_chr12_2_25_25_tree_initial_test_nogaps/chr12/sample_ids.in_nwk.txt
```

Samples not in Faith's graph which aligns well to others in the graph `HG00099.1, HG00706.1`
chosen from here:
...
grep chr12 /private/groups/patenlab/mira/centrolign/batch_submissions/extract_hors_HPRC/release2/contiguous_HORs_bed_files/HG00408_pat_hprc_r2_v1_hor_arrays.bed \
> /private/groups/patenlab/mira/centrolign/giraffe/extract_hifi_reads/HG00408_pat_hprc_r2_v1_hor_arrays.chr12.bed
```
...
samtools view -bh -@32 \
  -L /private/groups/patenlab/mira/centrolign/giraffe/extract_hifi_reads/HG00408_pat_hprc_r2_v1_hor_arrays.chr12.bed \
  /private/groups/patenlab/mira/centrolign/giraffe/extract_hifi_reads/HG00408.hifi_DC_minimap2_2.28.corrected.bam \
  > /private/groups/patenlab/mira/centrolign/giraffe/extract_hifi_reads/HG00408_pat_chr12_hor_array.hifi.bam

samtools index /private/groups/patenlab/mira/centrolign/giraffe/extract_hifi_reads/HG00408_pat_chr12_hor_array.hifi.bam
