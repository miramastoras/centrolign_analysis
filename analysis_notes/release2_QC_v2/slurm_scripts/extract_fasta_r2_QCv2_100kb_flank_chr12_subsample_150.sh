#!/bin/bash
#SBATCH --job-name=extract_hor_fastas_100kb_flank
...
#SBATCH --array=[1-150]%150
#SBATCH --exclude=phoenix-[09,10,22,23,24,18]
#SBATCH --output=logs/array_job_%A_task_%a.log
#SBATCH --time=1:00:00

SMP_FILE=/private/groups/patenlab/mira/centrolign/batch_submissions/centrolign/release2_QC_v2/per_smp_asat_beds_100kb_flank/chr12/chr12_subsample150.samples.txt
...
HOR_ARRAY_BED=/private/groups/patenlab/mira/centrolign/batch_submissions/centrolign/release2_QC_v2/per_smp_asat_beds_100kb_flank/chr${CHR}/${SMP}.${HAP}_asat_arrays.100kb_flank.bed

OUTPATH=/private/groups/patenlab/mira/centrolign/batch_submissions/centrolign/release2_QC_v2/extract_fastas_100kb_flank/chr${CHR}/
mkdir -p $OUTPATH
