...
```sh
#!/bin/bash
#SBATCH --job-name=CDR_dist_SNV_aln_bases
#SBATCH --partition=medium
#SBATCH --mail-user=mmastora@ucsc.edu
#SBATCH --mail-type=END
#SBATCH --nodes=1
...
mkdir -p /private/groups/patenlab/mira/centrolign/analysis/CDR_variant_regression/SNVs_pairwise_raw_midpoint_aln_bases/${chr}

python /private/groups/patenlab/mira/centrolign/github/centrolign_analysis/scripts/get_aligned_bases_bed.py \
    -c /private/groups/patenlab/mira/centrolign/analysis/variant_dist_CDR/aligned_bases_per_bed/dist_0.2_smp_contig_maps_cigars/${chr}.contig_maps.csv \
    -b /private/groups/patenlab/mira/centrolign/analysis/CDR_variant_regression/SNVs_pairwise_raw_midpoint/${CHR}/ \
    -s all_snvs.local_id_CDR_dist \
    -o /private/groups/patenlab/mira/centrolign/analysis/CDR_variant_regression/SNVs_pairwise_raw_midpoint_aln_bases/${chr}
```
