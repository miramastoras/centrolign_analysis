...
```sh
tail -n 17 /private/groups/patenlab/mira/centrolign/batch_submissions/centrolign/release2_QC_v2/MSA/centrolign_results.csv | grep "release 2 QC v2" | grep -v "chr20," | cut -f1 -d","   | while IFS=',' read -r subgroup ; do
