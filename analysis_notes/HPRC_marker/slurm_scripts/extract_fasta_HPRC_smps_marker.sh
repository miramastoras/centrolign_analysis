...
#SBATCH --array=[2-460]%460
#SBATCH --output=logs/array_job_%A_task_%a.log
#SBATCH --time=1:00:00

SMP_FILE=/private/groups/patenlab/mira/centrolign/batch_submissions/centrolign/HPRC_marker/hprc_all_samples_with_asats.txt
...
HOR_ARRAY_BED=/private/groups/patenlab/mira/centrolign/batch_submissions/centrolign/HPRC_marker/hprc_per_smp_asat_beds/${SMP}.hap${HAP}_asat_arrays.bed

for CHR in {1..22} X Y; do
    echo "chr${CHR}"
    OUTPATH=/private/groups/patenlab/mira/centrolign/batch_submissions/centrolign/HPRC_marker/extract_fastas_hprc/chr${CHR}
    mkdir -p $OUTPATH
